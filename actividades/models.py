...
class ShevetBankCuenta(models.Model):
    ...
    grupo = models.ForeignKey(ShevetBankGrupo, on_delete=models.SET_NULL, null=True, blank=True)
...
class ShevetBankMovimiento(models.Model):
    ...
    estacion = models.ForeignKey(ShevetBankEstacion, on_delete=models.SET_NULL, null=True, blank=True)
    madrij = models.ForeignKey(UsuarioCamp, on_delete=models.SET_NULL, null=True, blank=True)
...
class ShevetBankRonda(models.Model):
    estacion = models.ForeignKey(ShevetBankEstacion, on_delete=models.CASCADE)
    encargado = models.ForeignKey(UsuarioCamp, on_delete=models.SET_NULL, null=True, blank=True)
...
class ShevetBankParticipanteRonda(models.Model):
    ronda = models.ForeignKey(ShevetBankRonda, on_delete=models.CASCADE)
    cuenta = models.ForeignKey(ShevetBankCuenta, on_delete=models.CASCADE)
...
class ShevetBankPrestamo(models.Model):
    cuenta = models.ForeignKey(ShevetBankCuenta, on_delete=models.CASCADE)
    banco = models.ForeignKey(ShevetBankEstacion, on_delete=models.SET_NULL, null=True, blank=True)
    encargado = models.ForeignKey(UsuarioCamp, on_delete=models.SET_NULL, null=True, blank=True)
    cantidad = models.IntegerField()
    ...
    def __str__(self):
        return f"Préstamo {self.cuenta.janij.nombre} - ${self.cantidad}"
...
class ShevetBankSubasta(models.Model):
    ...
    grupo_ganando = models.ForeignKey(ShevetBankGrupo, on_delete=models.SET_NULL, null=True, blank=True)
